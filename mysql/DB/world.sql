...
CREATE TABLE `employee_infos` (
  ...
  `age` integer NOT NULL DEFAULT 9999,
  `address` varchar(30) NOT NULL DEFAULT '',
  PRIMARY KEY(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

set autocommit=0;
INSERT INTO `employee_infos` VALUES(1,'zuki', 33,'西新井栄町');
INSERT INTO `employee_infos` VALUES(2,'aichan', 32,'西新井栄町');
INSERT INTO `employee_infos` VALUES(3,'omochi', 3,'西新井栄町');
INSERT INTO `employee_infos` VALUES(4,'sui', 1,'西新井栄町');
commit;
